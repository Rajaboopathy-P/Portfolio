...
const rightToLeftElements = document.querySelectorAll('.skills-heading, .dev-icons, .exp-text-div, .projects-image-div');
const leftToRightElements = document.querySelectorAll('.skills-image-div, .skills-bullets, .exp-image-div, .projects-text-div');
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    // Update theme toggle button icon to match current theme
    ...
    // Alternating Browser Tab Title Effect (Only on Home/Index Page)
    if (document.getElementById('home')) {
        let isDefaultTitle = true;
        setInterval(() => {
            if (isDefaultTitle) {
                document.title = "Rajaboopathy | Fullstack Python Developer";
            } else {
                document.title = "Rajaboopathy | Portfolio";
            }
